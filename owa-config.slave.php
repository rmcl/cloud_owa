...
define('OWA_DB_HOST', 'ec2-184-72-160-10.compute-1.amazonaws.com'); // host name of the server housing the database
define('OWA_DB_USER', 'owauser'); // database user
define('OWA_DB_PASSWORD', 'Xa312u'); // database user's password
...
define('OWA_PUBLIC_URL', 'http://ec2-107-20-17-194.compute-1.amazonaws.com/');  
...
//define('OWA_USE_REMOTE_EVENT_QUEUE', true);
//define('OWA_REMOTE_EVENT_QUEUE_ENDPOINT', 'http://ec2-184-72-160-10.compute-1.amazonaws.com/queue.php');
